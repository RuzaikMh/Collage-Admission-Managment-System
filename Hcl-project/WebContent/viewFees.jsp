                  ...
                  <table class="table table-bordered table-hover">
                      ...
                      <% 
                        try{
                              ...
                              String sql;
                              if(query != null){
                               sql ="SELECT * FROM student_fees where name like '%"+query+"%'";
                              }
                              else {
                              ...
                              while(rs.next()){
				                      ...
				                      <td>
				                          <div>
				                          		<a href='UpdateFee.jsp?update=<%=rs.getString(1)%>' class='btn btn-warning btn-xs'>Update</a>
				                          </div>
				                          <br>
				                          <div>
				                              <a href='FeeDelete?delete=<%=rs.getString(1)%>' class='btn btn-danger btn-xs'>Delete&nbsp;</a>
				                          </div>
                      				</td>
