                  ...
                  <table class="table table-bordered table-hover">
                      ...
                      <% 
                        try{
                              ...
                              String sql;
                              if(query != null){
                               sql ="SELECT * FROM course_creation where courseName like '%"+query+"%'";
                              }
                              else {
                              ...
                              while(rs.next()){
				                      ...
				                      <td>
				                          <div>
				                          		<a href='updateCourse.jsp?update=<%=rs.getString(1)%>' class='btn btn-warning btn-xs'>Update</a>
				                          </div>
				                          <br>
				                          <div>
				                              <a href='CourseDelete?delete=<%=rs.getString(1)%>' class='btn btn-danger btn-xs'>Delete&nbsp;</a>
				                          </div>
                      				</td>
