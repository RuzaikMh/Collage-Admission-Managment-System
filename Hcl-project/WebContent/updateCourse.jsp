            ...
            <!-- Website Overview -->
              ...
              <div class="panel-body">
                ...
                <%
						...
						String query = "select * from course_creation where Course_ID = '"+num+"'";
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="courseID" value="<%=rs.getString(1)%>" type ="text" id ="text-only" class="form-control" aria-label="..." readonly="readonly" >
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="grade" value="<%=rs.getString(4)%>" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="courseName" value="<%=rs.getString(2)%>" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="months" value="<%=rs.getString(5)%>" type ="number" class="form-control" aria-label="..." required>
                            </div>
                        </div> 
                    </div>
                    <br>
                        ...
                        <div class="col-md-12">
                            <div class = "input-group">
                                ...
                                <input name ="lecture" value="<%=rs.getString(3)%>" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                    </div>
                    <br>
