          ...
          <div class="col-md-9 content">
            <!-- Website Overview -->
              ...
              <div class="panel-body">
                <form action = "UpdateRegisteredStudent" method = "post"> 
                	<%
						String num = request.getParameter("update");
						st = conn.createStatement();
						String query = "select * from student_registration where REGISTRATION_NUMBER = '"+num+"'";
						String query2 = "SELECT DISTINCT courseName FROM  course_creation";
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="studentName" value="<%=rs.getString(2)%>" type ="text" id ="text-only" class="form-control" aria-label="..." required >
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="registrationNumber" value="<%=rs.getString(1)%>" type ="text" class="form-control" aria-label="..." readonly>
                                <%}%>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="nic" value="<%=rs.getString(4)%>" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div> 
                    </div>
                    <br>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="phoneNumber" value="<%=rs.getString(5)%>" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name = "email" value="<%=rs.getString(6)%>" type ="email" class="form-control" aria-label="..." >
                            </div>
                        </div>
                    </div>
                    <br>
                        ...
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="address" value="<%=rs.getString(7)%>" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="date" value="<%=rs.getString(8)%>" type ="text" class="form-control" aria-label="...">
                            </div>
                        </div>
                    </div>
                    <br> 
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="province" value="<%=rs.getString(9)%>" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="district" value="<%=rs.getString(10)%>" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                    </div>
                    <br>
