                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="registrationNumber" type ="text" id ="text-only" class="form-control" aria-label="..." required >
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="paymentId" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="studentName" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                       <div class="col-md-6">
                            <div class = "input-group">
                                ...
                                <input name ="paymentAmount" type ="text" class="form-control" aria-label="..." required>
                            </div>
                        </div>
                    </div>
                    <br>
